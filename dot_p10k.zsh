...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=18
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=19
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=24
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=19
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=60
  ...
  function my_git_formatter() {
    ...
    local       meta='%F{117}' # light grey/white foreground
    local      clean='%F{117}' # light grey/white foreground
    local   modified='%F{117}' # light grey/white foreground
    local  untracked='%F{117}' # light grey/white foreground
    local conflicted='%F{117}' # light grey/white foreground
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=18
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=17
